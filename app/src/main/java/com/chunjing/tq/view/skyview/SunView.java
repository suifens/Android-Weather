...
public class SunView extends View {
    ...
    private void initView(Context context, @Nullable AttributeSet attrs) {
        mContext = context;
        marginTop = SizeUtils.dp2px(5);

        TypedArray type = context.obtainStyledAttributes(attrs, R.styleable.SunView);
        mCircleColor = type.getColor(R.styleable.SunView_sun_circle_color, getContext().getResources().getColor(R.color.color_333));
        mFontColor = type.getColor(R.styleable.SunView_sun_font_color, getContext().getResources().getColor(R.color.colorAccent));
        mRadius = (int) type.getDimension(R.styleable.SunView_sun_circle_radius, 50);
        mFontSize = type.getDimension(R.styleable.SunView_sun_font_size, 12);
...
//        mCirclePaint.setColor(mContext.getResources().getColor(R.color.color_999));
        ...
        iconSize = SizeUtils.dp2px(10);
        if (isSun) {
            mSunIcon = ConvertUtils.drawable2Bitmap(getResources().getDrawable(R.drawable.icon_sun));
        } else {
            mSunIcon = ConvertUtils.drawable2Bitmap(getResources().getDrawable(R.drawable.icon_moon));
        }

        lineBias = SizeUtils.dp2px(10);
    }
...
//        LogUtil.d("currentAngle: " + currentAngle);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // start x of sun
        positionX = mHalfWidth - mRadius - SizeUtils.dp2px(9);
        // start y of sun
        positionY = mRadius / 2f + marginTop - (mSunIcon.getHeight() >> 1);

        mRectF.set(mHalfWidth - mRadius, marginTop, mHalfWidth + mRadius, mRadius + marginTop);

        int height = mRadius / 2 + marginTop + SizeUtils.dp2px(40);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(mHalfWidth - mRadius - lineBias, mRadius / 2f + marginTop, mHalfWidth + mRadius + lineBias, mRadius / 2f + marginTop, mLinePaint);
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(sunrise, mHalfWidth - mRadius + dp8, mRadius + SizeUtils.dp2px(21) + marginTop, mTextPaint);
        canvas.drawText(startTime, mHalfWidth - mRadius + dp8, mRadius + SizeUtils.dp2px(37) + marginTop, mTimePaint);
        canvas.drawText(sunset, mHalfWidth + mRadius - dp8, mRadius + SizeUtils.dp2px(21) + marginTop, mTextPaint);
        canvas.drawText(endTime, mHalfWidth + mRadius - dp8, mRadius + SizeUtils.dp2px(37) + marginTop, mTimePaint);
    }

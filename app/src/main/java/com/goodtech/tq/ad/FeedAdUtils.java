...
public class FeedAdUtils {
    ...
    private static View getVerticalAdView(ViewGroup parent, View convertView, TTFeedAd ad, Activity activity,
                                          TTNativeAd.AdInteractionListener feedInteractionListener) {
    ...
    //渲染视频广告，以视频广告为例，以下说明
    private static View getVideoView(ViewGroup parent, View convertView, TTFeedAd ad, Activity activity,
                                     TTNativeAd.AdInteractionListener feedInteractionListener) {
    ...
    private static View getLargeAdView(ViewGroup parent, View convertView, TTFeedAd ad, Activity activity,
                                       TTNativeAd.AdInteractionListener feedInteractionListener) {
    ...
    private static View getGroupAdView(ViewGroup parent, View convertView, TTFeedAd ad, Activity activity,
                                       TTNativeAd.AdInteractionListener feedInteractionListener) {
    ...
    private static View getSmallAdView(ViewGroup parent, View convertView, TTFeedAd ad, Activity activity,
                                       TTNativeAd.AdInteractionListener feedInteractionListener) {
    ...
    private static void bindData(View convertView, AdViewHolder adViewHolder, TTFeedAd ad, MediationViewBinder viewBinder,

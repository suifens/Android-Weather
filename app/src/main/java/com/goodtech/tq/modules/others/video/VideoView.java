package com.goodtech.tq.modules.others.video;
...
public class VideoView extends FrameLayout implements IControlComponent {
    ...
    {
        LayoutInflater.from(getContext()).inflate(R.layout.layout_video_controller, this, true);

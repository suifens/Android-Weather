...
public class NotificationUtil {
    ...
    public static void updateNotification(Context context, int notifyId, String cityName, WeatherModel model) {
        NotificationCompat.Builder builder = notificationMap.get(notifyId);
        if (builder == null) {
            return;
        }
        ...
        if (model != null) {
            ...
            views.setTextViewText(R.id.tvUpdateTime, "更新于：" + TimeUtils.getNowTime());

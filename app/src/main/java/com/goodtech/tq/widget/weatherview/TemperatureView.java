...
public class TemperatureView extends View {
    ...
    private Paint dayPointPaint;
    private Paint nightPointPaint;
    ...
    private void initPaint(Context context, AttributeSet attrs) {
        ...
        dayPointPaint = new Paint();
        nightPointPaint = new Paint();
        linePaint = new Paint();
        textPaint = new Paint();

        linePaint.setColor(lineColor);
        dayPointPaint.setColor(Color.parseColor("#FFD34E"));
        dayPointPaint.setAntiAlias(true);
        nightPointPaint.setColor(Color.parseColor("#00C4FF"));
        nightPointPaint.setAntiAlias(true);
    ...
    private void drawPoint(Canvas canvas) {
        ...
        yPointNight = y2;
        mWidth = getWidth();
        canvas.drawCircle(x, y, radius, dayPointPaint);
        canvas.drawCircle(x2, y2, radius, nightPointPaint);
    }

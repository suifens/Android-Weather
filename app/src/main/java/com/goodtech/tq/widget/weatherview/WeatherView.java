...
public class WeatherView extends HorizontalScrollView {
    ...
    private int lineType = LINE_TYPE_DISCOUNT;
    ...
    public void setList(final List<Daily> list) {
        this.list = list;
    ...
    private int getMinTemp(List<Daily> list) {
        if (list != null) {
            return Collections.min(list, new MinTempComparator()).metric.minTemp;
        }
        return 0;
    }
    ...
    private static class MaxTempComparator implements Comparator<Daily> {
        @Override
        public int compare(Daily o1, Daily o2) {
            if (o1.metric.maxTemp == o2.metric.maxTemp) {
                return 0;
            } else if (o1.metric.maxTemp > o2.metric.maxTemp) {
                return 1;
            } else {
                return -1;
            }
    ...
    private static class MinTempComparator implements Comparator<Daily> {
        @Override
        public int compare(Daily o1, Daily o2) {
            if (o1.metric.minTemp == o2.metric.minTemp) {
                return 0;
            } else if (o1.metric.minTemp > o2.metric.minTemp) {
                return 1;
            } else {
                return -1;
            }
    ...
    public interface OnWeatherItemClickListener {
        void onItemClick(WeatherItemView itemView, int position, Daily Daily);
    }

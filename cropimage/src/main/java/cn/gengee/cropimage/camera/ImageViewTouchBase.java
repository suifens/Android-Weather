...
abstract class ImageViewTouchBase extends ImageView {
    ...
    public void setImageBitmapResetBase(final Bitmap bitmap, int degree, final boolean resetSupp) {
        setImageRotateBitmapResetBase(new RotateBitmap(bitmap, degree), resetSupp);
    }
